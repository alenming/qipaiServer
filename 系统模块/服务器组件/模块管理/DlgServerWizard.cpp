...
VOID CDlgServerOptionItem1::InitCtrlWindow()
{
	...
	WORD wServerType[5]={GAME_GENRE_GOLD,GAME_GENRE_SCORE,GAME_GENRE_MATCH,GAME_GENRE_EDUCATE};
	LPCTSTR pszServerType[5]={TEXT("财富类型"),TEXT("点值类型"),TEXT("比赛类型"),TEXT("练习类型")};
