#ifndef OXSIX_LOGIC_HEAD_FILE
#define OXSIX_LOGIC_HEAD_FILE
...
public:
	//分析扑克
	bool AnalysebCardData(const BYTE cbCardData[], BYTE cbCardCount, tagOxSixAnalyseResult & AnalyseResult);
