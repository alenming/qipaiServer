...
#define CT_SINGLE						1								//乌龙类型
#define CT_ONE_DOUBLE					2								//一对
#define CT_TWO_DOUBLE					3								//两对
#define CT_THREE						4								//三条
#define CT_FIVE_SINGLE_LINE				5								//顺子
#define CT_FIVE_FLUSH					6								//同花
#define CT_FIVE_THREE_DEOUBLE			7								//葫芦
#define CT_FIVE_FOUR_ONE				8								//铁支
#define CT_FIVE_TONGHUASHUN				9								//同花顺

//特殊类型
#define CT_EX_SANTONGHUA				10								//三同花
#define CT_EX_SANSHUNZI					11								//三顺子
#define CT_EX_LIUDUIBAN					12								//六对半
#define CT_EX_WUDUISANTIAO				13								//五对三条
#define CT_EX_SITAOSANTIAO				14								//四套三条
#define CT_EX_COUYISE					15								//凑一色
#define CT_EX_QUANXIAO					16								//全小
#define CT_EX_QUANDA					17								//全大
#define CT_EX_SANFENGTIANXIA			18								//三分天下
#define CT_EX_SANTONGHUASHUN			19								//三同花顺
#define CT_EX_SHIERHUANGZU				20								//十二皇族
#define CT_EX_YITIAOLONG				21								//一条龙
#define CT_EX_ZHIZUNQINGLONG			22								//至尊清龙
