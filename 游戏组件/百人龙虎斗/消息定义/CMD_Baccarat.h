...
//玩家索引
#define AREA_DRAGON					0									//龙索引
#define AREA_TIGER					1									//虎索引
#define AREA_PING					2									//和索引
#define AREA_MAX					3									//最大区域

//区域倍数multiple
#define MULTIPLE_XIAN				2									//闲家倍数
#define MULTIPLE_PING				17									//平家倍数
...
{
	WORD							wCancelUser;						//申请玩家
};

//切换庄家
struct CMD_S_ChangeBanker
{
	WORD							wBankerUser;						//申请玩家
