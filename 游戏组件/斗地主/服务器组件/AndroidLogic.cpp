...
//扑克数据
const BYTE	CAndroidLogic::m_cbCardData[FULL_COUNT] =
{
...
//获取类型
BYTE CAndroidLogic::GetCardType(const BYTE cbCardData[], BYTE cbCardCount)
{
	//简单牌型
	switch (cbCardCount)
	{
...
//排列扑克
VOID CAndroidLogic::SortCardList(BYTE cbCardData[], BYTE cbCardCount, BYTE cbSortType)
{
	//数目过虑
...
//混乱扑克
VOID CAndroidLogic::RandCardList(BYTE cbCardBuffer[], BYTE cbBufferCount)
{
	//混乱准备
...
//删除扑克
bool CAndroidLogic::RemoveCard(const BYTE cbRemoveCard[], BYTE cbRemoveCount, BYTE cbCardData[], BYTE cbCardCount)
{
	//检验数据
...
//有效判断
bool CAndroidLogic::IsValidCard(BYTE cbCardData)
{
	//获取属性
...
//逻辑数值
BYTE CAndroidLogic::GetCardLogicValue(BYTE cbCardData)
{
	//扑克属性
	BYTE cbCardColor=GetCardColor(cbCardData);
	BYTE cbCardValue=GetCardValue(cbCardData);
...
//对比扑克
bool CAndroidLogic::CompareCard(const BYTE cbFirstCard[], const BYTE cbNextCard[], BYTE cbFirstCount, BYTE cbNextCount)
{
	//获取类型
...
//出牌搜索
bool CAndroidLogic::SearchOutCard(const BYTE cbHandCardData[], BYTE cbHandCardCount, const BYTE cbTurnCardData[], BYTE cbTurnCardCount, tagOutCardResult & OutCardResult)
{
	//设置结果
...
//构造扑克
BYTE CAndroidLogic::MakeCardData(BYTE cbValueIndex, BYTE cbColorIndex)
{
	return (cbColorIndex<<4)|(cbValueIndex+1);
}

//分析扑克
VOID CAndroidLogic::AnalysebCardData(const BYTE cbCardData[], BYTE cbCardCount, tagAnalyseResult & AnalyseResult)
{
	//设置结果
...
//分析分布
VOID CAndroidLogic::AnalysebDistributing(const BYTE cbCardData[], BYTE cbCardCount, tagDistributing & Distributing)
{
	//设置变量
...
//出牌搜索
bool CAndroidLogic::SearchOutCard(const BYTE cbHandCardData[], BYTE cbHandCardCount, const BYTE cbTurnCardData[], BYTE cbTurnCardCount, WORD wOutCardUser, WORD wMeChairID, tagOutCardResult & OutCardResult)
{
	//玩家判断
...
//分析炸弹
VOID CAndroidLogic::GetAllBomCard(BYTE const cbHandCardData[], BYTE const cbHandCardCount, BYTE cbBomCardData[], BYTE &cbBomCardCount)
{
...
//分析顺子
VOID CAndroidLogic::GetAllLineCard(BYTE const cbHandCardData[], BYTE const cbHandCardCount, BYTE cbLineCardData[], BYTE &cbLineCardCount)
{
...
//分析三条
VOID CAndroidLogic::GetAllThreeCard(BYTE const cbHandCardData[], BYTE const cbHandCardCount, BYTE cbThreeCardData[], BYTE &cbThreeCardCount)
{
	BYTE cbTmpCardData[MAX_COUNT] ;
	CopyMemory(cbTmpCardData, cbHandCardData, cbHandCardCount) ;
...
//分析对子
VOID CAndroidLogic::GetAllDoubleCard(BYTE const cbHandCardData[], BYTE const cbHandCardCount, BYTE cbDoubleCardData[], BYTE &cbDoubleCardCount)
{
	BYTE cbTmpCardData[MAX_COUNT] ;
	CopyMemory(cbTmpCardData, cbHandCardData, cbHandCardCount) ;
...
//分析单牌
VOID CAndroidLogic::GetAllSingleCard(BYTE const cbHandCardData[], BYTE const cbHandCardCount, BYTE cbSingleCardData[], BYTE &cbSingleCardCount)
{
	cbSingleCardCount =0 ;
...
//分析出牌
VOID CAndroidLogic::AnalyseOutCardType(BYTE const cbHandCardData[], BYTE const cbHandCardCount, tagOutCardTypeResult CardTypeResult[12 + 1])
{
...
//分析牌型
VOID CAndroidLogic::AnalyseOutCardType(BYTE const cbHandCardData[], BYTE const cbHandCardCount, BYTE const cbTurnCardData[], BYTE const cbTurnCardCount, tagOutCardTypeResult CardTypeResult[12 + 1])
{
	ZeroMemory(CardTypeResult, sizeof(CardTypeResult[0])*12) ;
	//数据校验
...
//单牌个数
BYTE CAndroidLogic::AnalyseSinleCardCount(BYTE const cbHandCardData[], BYTE const cbHandCardCount, BYTE const cbWantOutCardData[], BYTE const cbWantOutCardCount, BYTE cbSingleCardData[])
{
	BYTE cbRemainCard[MAX_COUNT] ;
	BYTE cbRemainCardCount=0 ;
	...
	GetAllCardFunArray[0] = &CAndroidLogic::GetAllBomCard;		//炸弹函数
	GetAllCardFunArray[1] = &CAndroidLogic::GetAllLineCard;	//顺子函数
	GetAllCardFunArray[2] = &CAndroidLogic::GetAllThreeCard;	//三条函数
	GetAllCardFunArray[3] = &CAndroidLogic::GetAllDoubleCard;	//对子函数
...
//设置扑克
VOID CAndroidLogic::SetUserCard(WORD wChairID, BYTE cbCardData[], BYTE cbCardCount)
{
...
//设置底牌
VOID CAndroidLogic::SetBackCard(WORD wChairID, BYTE cbBackCardData[], BYTE cbCardCount)
{
...
//设置庄家
VOID CAndroidLogic::SetBanker(WORD wBanker)
{
	m_wBankerUser = wBanker ;
}
//叫牌扑克
VOID CAndroidLogic::SetLandScoreCardData(BYTE cbCardData[], BYTE cbCardCount)
{
...
//删除扑克
VOID CAndroidLogic::RemoveUserCardData(WORD wChairID, BYTE cbRemoveCardData[], BYTE cbRemoveCardCount)
{
...
//地主出牌（先出牌）
VOID CAndroidLogic::BankerOutCard(const BYTE cbHandCardData[], BYTE cbHandCardCount, tagOutCardResult & OutCardResult)
{
	//零下标没用
...
//地主出牌（后出牌）
VOID CAndroidLogic::BankerOutCard(const BYTE cbHandCardData[], BYTE cbHandCardCount, WORD wOutCardUser, const BYTE cbTurnCardData[], BYTE cbTurnCardCount, tagOutCardResult & OutCardResult)
{
	//初始变量
	ZeroMemory(&OutCardResult, sizeof(OutCardResult)) ;
...
//地主上家（先出牌）
VOID CAndroidLogic::UpsideOfBankerOutCard(const BYTE cbHandCardData[], BYTE cbHandCardCount, WORD wMeChairID, tagOutCardResult & OutCardResult)
{
	//零下标没用
	tagOutCardTypeResult CardTypeResult[12+1] ;
	ZeroMemory(CardTypeResult, sizeof(CardTypeResult)) ;
...
//地主上家（后出牌）
VOID CAndroidLogic::UpsideOfBankerOutCard(const BYTE cbHandCardData[], BYTE cbHandCardCount, WORD wOutCardUser, const BYTE cbTurnCardData[], BYTE cbTurnCardCount, tagOutCardResult & OutCardResult)
{
...
//地主下家（先出牌）
VOID CAndroidLogic::UndersideOfBankerOutCard(const BYTE cbHandCardData[], BYTE cbHandCardCount, WORD wMeChairID, tagOutCardResult & OutCardResult)
{
	//零下标没用
	tagOutCardTypeResult CardTypeResult[12+1] ;
	ZeroMemory(CardTypeResult, sizeof(CardTypeResult)) ;
...
//地主下家（后出牌）
VOID CAndroidLogic::UndersideOfBankerOutCard(const BYTE cbHandCardData[], BYTE cbHandCardCount, WORD wOutCardUser, const BYTE cbTurnCardData[], BYTE cbTurnCardCount, tagOutCardResult & OutCardResult)
{
	//初始变量
	ZeroMemory(&OutCardResult, sizeof(OutCardResult)) ;
...
//叫分判断
BYTE CAndroidLogic::LandScore(WORD wMeChairID, BYTE cbCurrentLandScore)
{
	//大牌数目
