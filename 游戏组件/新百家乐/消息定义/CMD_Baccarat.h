...
#define SUB_S_MIAN_YONG				2018									//用户免佣
...
//免佣
struct CMD_S_MianYong
{
	BYTE							cbMianYong;							//免佣标识
};
...
struct CMD_S_StatusPlay
{
	...
	BYTE							cbResult[AREA_MAX];					//结果  0:龙 1虎 2和
...
#define SUB_C_MIAN_YONG				104									//免佣金
...
//免佣金
struct CMD_C_MianYong
{
	BYTE							cbMianYong;						//是否免佣金
};
